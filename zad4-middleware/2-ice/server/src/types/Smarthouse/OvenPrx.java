...
public interface OvenPrx extends DevicePrx
{
    ...
    default java.util.concurrent.CompletableFuture<OvenProgram> getProgramAsync(java.util.Map<String, String> context)
    {
    ...
    default void setProgram(OvenProgram program)
        throws GenericError
    {
        setProgram(program, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void setProgram(OvenProgram program, java.util.Map<String, String> context)
        throws GenericError
    {
        try
        {
            _iceI_setProgramAsync(program, context, true).waitForResponseOrUserEx();
        }
    ...
    default java.util.concurrent.CompletableFuture<Void> setProgramAsync(OvenProgram program)
    {
        return _iceI_setProgramAsync(program, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> setProgramAsync(OvenProgram program, java.util.Map<String, String> context)
    {
        return _iceI_setProgramAsync(program, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_setProgramAsync(OvenProgram iceP_program, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "setProgram", null, sync, _iceE_setProgram);
        f.invoke(true, context, null, ostr -> {
                     OvenProgram.ice_write(ostr, iceP_program);
                 }, null);
        return f;
    }

    /** @hidden */
    static final Class<?>[] _iceE_setProgram =
    {
        GenericError.class
    };
