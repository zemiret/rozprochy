...
public interface BulbulatorPrx extends DevicePrx
{
    ...
    {
        return _iceI_getJokeAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<String[]> getJokeAsync(java.util.Map<String, String> context)
    {
        return _iceI_getJokeAsync(context, false);
    }
